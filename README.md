...
Please read READMEBasicInstallation.md and requirements.txt to install basic environment first before continue.
...
1. Clone the repository and navigate to the downloaded folder.
	...
	```	
		git clone https://github.com/Hoangvo92/dog-classification-project.git
...
Ensure you have numpy, matplotlib, pandas, and jupyter notebook installed by doing the following:
    ...
    ...
Install torchvision: https://anaconda.org/pytorch/torchvision
   ...
